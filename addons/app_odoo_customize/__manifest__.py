...

{
    ...
    'data': [
        ...
        # data
        'static/data/ir_config_parameter_data.xml',
        'static/data/ir_module_module_data.xml',
        # 'data/digest_template_data.xml',
        'static/data/res_company_data.xml',
        'static/data/res_config_settings_data.xml',
    ],
    'assets': {
        'web.assets_backend': [
            ...
            'app_odoo_customize/static/src/css/loading.css',
